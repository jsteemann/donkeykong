...
process_directory "Post" "document" "--datatype CreatorPersonId=string" "--datatype ContainerForumId=string" "--datatype LocationCountryId=string" "--translate id=_key"
...
process_directory "Person_studyAt_University" "edge" "--from-collection-prefix=Person" "--to-collection-prefix=Organisation" "--translate PersonId=_from" "--translate UniversityId=_to" 
process_directory "Person_workAt_Company" "edge" "--from-collection-prefix=Person" "--to-collection-prefix=Organisation" "--translate PersonId=_from" "--translate CompanyId=_to" 
