...
process_directory "dynamic/Forum" "Forum" "document" "--datatype ModeratorPersonId=string" "--merge-attributes _key=[id]"
...
process_directory "dynamic/Forum_hasTag_Tag" "Forum_hasTag_Tag" "edge" "--from-collection-prefix=Forum" "--to-collection-prefix=Tag" "--merge-attributes _from=[ForumId]" "--merge-attributes _to=[TagId]"
process_directory "static/TagClass" "isSubclassOf" "edge" "--datatype id=string" "--datatype SubclassOfTagClassId=string" "--from-collection-prefix=TagClass" "--to-collection-prefix=TagClass" "--translate id=_from" "--translate SubclassOfTagClassId=_to"

process_directory "static/Organisation" "Organisation" "document" "--merge-attributes _key=[id]"
